...
export CHERRY_PICKER_EVENT_QUEUE="8192"
...
export CHERRY_PICKER_DHT_PACKET_WORKERS="64"
export CHERRY_PICKER_DHT_PACKET_JOBS="512"
export CHERRY_PICKER_DHT_MAX_NODES="5000"
export CHERRY_PICKER_DHT_REFRESH_NODES="128"
export CHERRY_PICKER_METADATA_ENABLED="true"
export CHERRY_PICKER_METADATA_BLACKLIST="65536"
export CHERRY_PICKER_METADATA_REQUEST_QUEUE="4096"
export CHERRY_PICKER_METADATA_WORKERS="64"
...
export CHERRY_PICKER_EXPORTER_TIMEOUT="15s"
