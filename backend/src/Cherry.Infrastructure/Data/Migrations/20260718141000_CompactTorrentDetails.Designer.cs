...
namespace Cherry.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260718141000_CompactTorrentDetails")]
    partial class CompactTorrentDetails
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cherry.Domain.Entities.TorrentDetail", b =>
                {
                    b.Property<long>("TorrentId")
                        .HasColumnType("bigint")
                        .HasColumnName("torrent_id");
                    ...
                    b.ToTable("torrent_details", null, t =>
                        {
                            t.HasCheckConstraint("CK_torrent_details_payload", "octet_length(payload) BETWEEN 3 AND 67108864");
                        });
                });
            ...
            modelBuilder.Entity("Cherry.Domain.Entities.TorrentDetail", b =>
                {
                    b.HasOne("Cherry.Domain.Entities.Torrent", null)
                        .WithOne()
                        .HasForeignKey("Cherry.Domain.Entities.TorrentDetail", "TorrentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
