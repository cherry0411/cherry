...
var SearchPage = {
    ...
    computed: { q: function () { return (this.$route.query.q || '').trim(); }, heatWindow: function () { var w = String(this.$route.query.heatWindow || '7d'); return this.heatWindows.indexOf(w) >= 0 ? w : '7d'; }, page: function () { return Math.max(1, parseInt(this.$route.query.page) || 1); }, pageSize: function () { return 20; }, tp: function () { return Math.max(1, Math.ceil(this.total / this.pageSize)); } },
